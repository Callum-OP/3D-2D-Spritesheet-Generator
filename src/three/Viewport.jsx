...
export default function Viewport() {
  ...
  return (
    ...
    >
      ...
      {/* Capture-region guide: a centred square matching the orthographic frustum
          (its height fills the viewport). Everything outside is dimmed via a huge
          box-shadow spread, so you see exactly what each sprite cell will grab. */}
      {capturePreview && (
        <div
          aria-hidden
          style={{
            ...
            border: '1px solid rgba(92, 240, 160, 0.9)',
            boxShadow: '0 0 0 9999px rgba(10, 12, 16, 0.35)',
            pointerEvents: 'none',
          }}
        />
      )}
